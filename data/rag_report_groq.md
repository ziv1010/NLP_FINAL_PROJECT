...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| groq_large | llama-3.3-70b-versatile | 15 | 0.3646 | 0.8283 |  | 0 |
| groq_scout | meta-llama/llama-4-scout-17b-16e-instruct | 15 | 0.3618 | 0.8134 |  | 0 |

## Qualitative Analysis

Evaluated providers: groq_large, groq_scout. Factual and opinion-summary questions (26 provider-question rows) test whether retrieval surfaces relevant posts and comments from the FAISS index. Adversarial questions (4 provider-question rows) test whether models refuse to invent evidence when the corpus does not contain an answer. Review the per-question rows to flag faithfulness manually; the summary table reports faithfulness only for rows that have been reviewed.
